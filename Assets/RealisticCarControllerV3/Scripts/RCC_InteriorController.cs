...
/// </summary>
[AddComponentMenu("BoneCracker Games/Realistic Car Controller/Misc/RCC Interior Controller")]
public class RCC_InteriorController : MonoBehaviour {
    ...
    private void Update() {
        ...
        float steeringAngle = ( Mathf.Lerp(0.1f, 0.9f, (steerInput + 1f) / 2f)) * 360;

        

        var old_steer_rotation = Steer.rotation;
        Steer.transform.localEulerAngles = new Vector3 (180+steeringAngle, 52.2f, 0);
