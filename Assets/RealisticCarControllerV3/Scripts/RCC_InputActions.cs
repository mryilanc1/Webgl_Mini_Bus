    ...
    public struct VehicleActions
    {
        ...
        public void SetCallbacks(IVehicleActions instance)
        {
            if (m_Wrapper.m_VehicleActionsCallbackInterface != null)
            {
                ...
                @InteriorLights.started -= m_Wrapper.m_VehicleActionsCallbackInterface.OnInteriorLights;
                @InteriorLights.performed -= m_Wrapper.m_VehicleActionsCallbackInterface.OnInteriorLights;
                @InteriorLights.canceled -= m_Wrapper.m_VehicleActionsCallbackInterface.OnInteriorLights;
